#include "algorithms/idaStarF2l.h"
#include "algorithms/idaStarCross.h"
...
int main(int argc, const char *argv[]) {
    ...
    std::cout << "  curl \"http://localhost:8080/api/v1/greeting?scramble='R U R U'\"" << std::endl;
    std::cout << "  curl \"http://localhost:8080/api/v1/greeting_one_by_one?scramble='R U R U'&order=1,2,3,4\"" << std::endl;
